...
import { ref } from "vue";
import { subjectHook } from "./utils/hook";
  ...
  <div class="main">
    ...
    >
      <el-form-item label="名称：" prop="subjectTitle">
        <el-input
          v-model="searchFormParams.subjectTitle"
          placeholder="请输入科目名称"
          clearable
          class="!w-[200px]"
        />
      ...
      <el-form-item label="考试" prop="examId">
        <el-select
          v-model="searchFormParams.examId"
          placeholder="请选择考试"
          clearable
          class="!w-[180px]"
        >
    ...
    <!-- table bar 包裹  table -->
    <PureTableBar title="科目列表" :columns="columns" @refresh="onSearch">
      <!-- 表格操作栏 -->
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        <pure-table
          ...
          @page-size-change="getSubjectList"
          @page-current-change="getSubjectList"
          @sort-change="getSubjectList"
          @selection-change="
