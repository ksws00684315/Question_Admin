...
import { ref } from "vue";
import { examHook } from "./utils/hook";
...
<template>
  <div class="main">
    ...
    >
      <el-form-item label="名称：" prop="examTitle">
        <el-input
          v-model="searchFormParams.examTitle"
          placeholder="请输入考试名称"
          clearable
          class="!w-[200px]"
        />
    ...
    <!-- table bar 包裹  table -->
    <PureTableBar title="考试列表" :columns="columns" @refresh="onSearch">
      <!-- 表格操作栏 -->
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        <pure-table
          ...
          @page-size-change="getExamList"
          @page-current-change="getExamList"
          @sort-change="getExamList"
          @selection-change="
