...
import { ref } from "vue";
import { subQuestionHook } from "./utils/hook";
...
<template>
  <div class="main">
    ...
    <!-- table bar 包裹  table -->
    <PureTableBar title="题目列表" :columns="columns" @refresh="onSearch">
      <!-- 表格操作栏 -->
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        <pure-table
          ...
          @page-size-change="getQuestionList"
          @page-current-change="getQuestionList"
          @sort-change="getQuestionList"
          @selection-change="
